...
void SD_SetRecordingActive(void) { RecordingSemaphore = true; }
...
void SD_ClearRecordingActive(void) { RecordingSemaphore = false; }
...
boolean SD_RecordingActive(void) { return RecordingSemaphore; }
