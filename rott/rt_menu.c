...
char order[21] = {di_west,	  di_east,	 di_north,	 di_south,	bt_run,	     bt_use,	   bt_attack,
		  bt_strafe,	  bt_strafeleft, bt_straferight, bt_lookup,	bt_lookdown, bt_aimbutton, bt_horizonup,
		  bt_horizondown, bt_swapweapon, bt_dropweapon,	 bt_turnaround, bt_autorun,  bt_message,   bt_directmsg};
...
static char* BattleModeDescriptions[battle_NumBattleModes - 1] = {"Kill your enemies!  Don't get killed!  Kill some more!",
...
static char* GravityOptionDescriptions[3] = {"Similar to gravity on the moon", "Normal Gravity (9.81 m/s^2 !)", "Similar to gravity on Jupiter"};

static char* SpeedOptionDescriptions[2] = {"Player speeds are determined by character", "All players can move at the fastest possible speed"};
...
static char* LightLevelOptionDescriptions[6] = {"Very dark, cave-like", "Lighting determined by level design", "Full brightness",
...
static char* DangerDamageOptionDescriptions[3] = {"Environmental dangers' damage is relatively low", "Environmental dangers' damage normal",
...
static char* BattleModeNames[battle_NumBattleModes - 1] = {"NORMAL COMM-BAT", "SCORE MORE", "COLLECTOR",	"SCAVENGER", "HUNTER", "TAG",
...
// MENU ITEMS
//
CP_MenuNames MainMenuNames[] = {"NEW GAME",	"COMM-BAT� GAME", "RESTORE GAME", "SAVE GAME", "OPTIONS", "ORDERING INFO",
...
CP_itemtype LSMenu[] = {{CP_Active, "", 'a', NULL}, {CP_Active, "", 'b', NULL}, {CP_Active, "", 'c', NULL}, {CP_Active, "", 'd', NULL},
			{CP_Active, "", 'e', NULL}, {CP_Active, "", 'f', NULL}, {CP_Active, "", 'g', NULL}, {CP_Active, "", 'h', NULL},
			{CP_Active, "", 'i', NULL}, {CP_Active, "", 'j', NULL}, {CP_Active, "", 'k', NULL}, {CP_Active, "", 'l', NULL},
			{CP_Active, "", 'm', NULL}, {CP_Active, "", 'n', NULL}, {CP_Active, "", 'o', NULL}};

CP_MenuNames CtlMenuNames[] = {"MOUSE ENABLED",	   "JOYSTICK ENABLED", "USE JOYSTICK PORT 2", "GAMEPAD ENABLED",   "SPACEBALL ENABLED",
			       "CYBERMAN ENABLED", "ADJUST THRESHOLD", "MOUSE SENSITIVITY",   "CUSTOMIZE CONTROLS"};
...
CP_itemtype CusMenu[] = {{CP_Active, "ctl_mic\0", 'a', NULL}, {CP_Inactive, "ctl_mic\0", 'a', NULL}, {CP_Inactive, "ctl_mic\0", 'a', NULL},
...
CP_itemtype CustomMenu[] = {
	{2, "custom1\0", 'C', (menuptr)CP_Keyboard}, {1, "custom2\0", 'C', (menuptr)CP_Mouse}, {1, "custom3\0", 'C', (menuptr)CP_Joystick}};

#define KEYNAMEINDEX 21

CP_MenuNames NormalKeyNames[] = {"LEFT               \x9      ", "RIGHT              \x9      ", "FORWARD            \x9      ",
...
CP_itemtype NormalKeyMenu[] = {{2, "\0", 'L', (menuptr)DefineKey}, {1, "\0", 'R', (menuptr)DefineKey}, {1, "\0", 'F', (menuptr)DefineKey},
...
CP_MenuNames ControlNames[] = {"NONE",	 "LEFT",     "RIGHT",	      "FORWARD",      "BACKWARD",    "RUN",	      "OPEN",
			       "FIRE",	 "STRAFE",   "STRAFE LEFT",   "STRAFE RIGHT", "LOOK/FLY UP", "LOOK/FLY DOWN", "AIM",
			       "AIM UP", "AIM DOWN", "TOGGLE WEAPON", "DROP WEAPON",  "VOLTE-FACE",  "AUTORUN",	      "MAP"};

int controlorder[NUMCONTROLNAMES] = {bt_nobutton,  di_west,	   di_east,	  di_north,	  di_south,	 bt_run,      bt_use,
...
CP_itemtype ControlSelectMenu[] = {{2, "\0", 'N', NULL}, {1, "\0", 'L', NULL}, {1, "\0", 'R', NULL}, {1, "\0", 'F', NULL}, {1, "\0", 'B', NULL},
...
CP_MenuNames MouseBtnNames[] = {"             B0  \x9             ", "             B1  \x9             ", "             B2  \x9             ",
				"DOUBLE-CLICK B0  \x9             ", "DOUBLE-CLICK B1  \x9             ", "DOUBLE-CLICK B2  \x9             "};
...
CP_MenuNames JoyBtnNames[] = {"             B0  \x9             ", "             B1  \x9             ", "             B2  \x9             ",
			      "             B3  \x9             ", "DOUBLE-CLICK B0  \x9             ", "DOUBLE-CLICK B1  \x9             ",
			      "DOUBLE-CLICK B2  \x9             ", "DOUBLE-CLICK B3  \x9             "};

CP_iteminfo JoyBtnItems = {19, 48, 8, 0, 11, JoyBtnNames, mn_8x8font};

CP_itemtype JoyBtnMenu[] = {{2, "\0", 'B', (menuptr)DefineJoyBtn}, {1, "\0", 'B', (menuptr)DefineJoyBtn}, {1, "\0", 'B', (menuptr)DefineJoyBtn},
			    {1, "\0", 'B', (menuptr)DefineJoyBtn}, {1, "\0", 'D', (menuptr)DefineJoyBtn}, {1, "\0", 'D', (menuptr)DefineJoyBtn},
...
CP_itemtype PlayerMenu[] = {
	{2, "name1\0", 'T', NULL}, {1, "name2\0", 'T', NULL}, {1, "name3\0", 'D', NULL}, {1, "name4\0", 'L', NULL}, {1, "name5\0", 'I', NULL},
};
...
CP_MenuNames OptionsNames[] = {"AUTO DETAIL ADJUST", "LIGHT DIMINISHING", "BOBBIN'",	    "FLOOR AND CEILING", "DOUBLE-CLICK SPEED",
			       "MENU FLIP SPEED",    "DETAIL LEVELS",	  "VIOLENCE LEVEL", "SCREEN SIZE"};
// bna added
...
CP_itemtype ExtOptionsMenu[] = {{1, "", 'M', NULL}, {1, "", 'I', NULL}, {1, "", 'C', NULL}, {1, "", 'J', NULL}, {1, "", 'F', NULL}};
...
CP_itemtype BattleMenu[] = {
	{2, "bplay\0", 'P', (menuptr)BattleNoTeams}, {1, "playteam\0", 'P', (menuptr)BattleTeams}, {1, "comopt\0", 'C', (menuptr)CP_BattleOptions}};
...
CP_itemtype ViolenceMenu[] = {{2, "vnone\0", 'N', NULL}, {1, "vsome\0", 'S', NULL}, {1, "valot\0", 'A', NULL}, {1, "vexcess\0", 'E', NULL}};
...
CP_MenuNames ModeMenuNames[] = {"NORMAL", "SCORE MORE", "COLLECTOR", "SCAVENGER", "HUNTER", "TAG", "ELUDER", "DELUDER", "CAPTURE THE TRIAD"};

CP_iteminfo ModeItems = {MENU_X, MENU_Y + 1, 9, 0, 24, ModeMenuNames, mn_largefont};

CP_itemtype ModeMenu[] = {{CP_CursorLocation, "normal\0", 'N', (menuptr)CP_BattleMenu}, {CP_Active, "scorem\0", 'S', (menuptr)CP_BattleMenu},
...
CP_itemtype BOptMenu[] = {{2, "gravity\0", 'G', (menuptr)CP_GravityOptions},	   {1, "speed\0", 'S', (menuptr)CP_SpeedOptions},
...
CP_itemtype HitPointMenu[] = {{2, "b_one\0", 'O', NULL}, {1, "b_25\0", 'a', NULL},  {1, "b_char\0", 'C', NULL}, {1, "b_100\0", 'a', NULL},
			      {1, "b_250\0", 'a', NULL}, {1, "b_500\0", 'a', NULL}, {1, "b_4000\0", 'a', NULL}};
...
CP_itemtype SpawnMenu[] = {{2, "b_danger\0", 'S', NULL}, {1, "b_health\0", 'S', NULL}, {1, "b_weap\0", 'S', NULL},   {1, "b_mines\0", 'S', NULL},
			   {1, "b_rpawn\0", 'R', NULL},	 {1, "b_persis\0", 'W', NULL}, {1, "b_rndwpn\0", 'R', NULL}, {1, "b_friend\0", 'F', NULL}};
...
CP_itemtype TimeLimitMenu[] = {{2, "b_1\0", 'a', NULL},	 {1, "b_2\0", 'a', NULL},  {1, "b_5\0", 'a', NULL},  {1, "b_10\0", 'a', NULL},
			       {1, "b_21\0", 'a', NULL}, {1, "b_30\0", 'a', NULL}, {1, "b_99\0", 'a', NULL}, {1, "vnone\0", 'N', NULL}};
...
CP_itemtype MultiPageCustomMenu[] = {
	{1, "", 'N', NULL}, {1, "", 'P', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL},
	{1, "", 'a', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL}, {1, "", 'a', NULL},
};
...
void WriteMenuInfo(void) { ConvertPasswordToPasswordString(); }
	...
	do
	{
		...
		if (numactive > 1)
		{
			...
			case dir_North:
				...
				if ((handlewhich) &&
				    (((items + handlewhich - 1)->active == CP_CursorLocation) || ((items + handlewhich - 1)->active == CP_Active)))
				{
					y -= 6;
					DrawHalfStep(x, y);
					playsnd = false;
...
void CP_ViewScores(void) { CheckHighScore(0, 0, true); }
...
void CP_Quit(int which)
{
	...
	if (which != -1)
	{
		ClearMenuBuf();
		DrawMainMenu();
		DrawMenuBufItem(MainItems.x, ((MainItems.curpos * 14) + (MainItems.y - 2)), W_GetNumForName(LargeCursor) + CursorFrame[CursorNum]);
		RefreshMenuBuf(0);
	}
}
...
void DrawLoadSaveScreen(int loadsave)
{
	...
	for (i = 0; i < NUMSAVEGAMES; i++)
		PrintLSEntry(i);
	DrawMenuBufItem(LSItems.x, ((LSItems.curpos * 9) + (LSItems.y)), W_GetNumForName(SmallCursor) + CursorFrame[CursorNum]);
	DisplayInfo(7);
	if ((!numdone) && ingame && inmenu)
		RefreshMenuBuf(0);
	else
...
void MouseSensitivity(void) { SliderMenu(&mouseadjustment, 11, 0, 21, 81, 240, 1, "block1", NULL, "Mouse Sensitivity", "Slow", "Fast"); }
...
void DoThreshold(void) { SliderMenu(&threshold, 15, 1, 44, 81, 194, 1, "block2", NULL, "Adjust Threshold", "Small", "Large"); }
...
void DrawCtlScreen(void)
{
	...
	DrawMenuBufItem(CtlItems.x, ((CtlItems.curpos * 14) + (CtlItems.y - 2)), W_GetNumForName(LargeCursor) + CursorFrame[CursorNum]);
...
void DrawCustomMenu(void)
{
	...
	DrawMenuBufItem(CustomItems.x, ((CustomItems.curpos * 14) + (CustomItems.y - 2)), W_GetNumForName(LargeCursor) + CursorFrame[CursorNum]);
	DisplayInfo(0);
	FlipMenuBuf();
}
...
boolean SliderMenu(int* number, int upperbound, int lowerbound, int erasex, int erasey, int erasew, int numadjust, char* blockname,
...
void CP_ViolenceLevel(void)
{
	...
	if (ingame)
	{
		CP_ErrorMsg("Change Violence Level", "The current game must be ended to change the Violence Level.", mn_largefont);
	}
	else if (POK)
	{
		memset(p1, 0, 13);
...
void DrawBattleOptionDescription(int w) { DrawOptionDescription(BattleOptionDescriptions, w); }
//****************************************************************************
//
...
void DrawGravityOptionDescription(int w) { DrawOptionDescription(GravityOptionDescriptions, w); }
//****************************************************************************
//
...
void DrawSpeedOptionDescription(int w) { DrawOptionDescription(SpeedOptionDescriptions, w); }
//****************************************************************************
//
...
void DrawAmmoOptionDescription(int w) { DrawOptionDescription(AmmoOptionDescriptions, w); }
//****************************************************************************
//
...
void DrawHitPointsOptionDescription(int w) { DrawOptionDescription(HitPointsOptionDescriptions, w); }
//****************************************************************************
//
...
void DrawRadicalOptionDescription(int w) { DrawOptionDescription(RadicalOptionDescriptions, w); }
//****************************************************************************
//
...
void DrawLightLevelOptionDescription(int w) { DrawOptionDescription(LightLevelOptionDescriptions, w); }
//****************************************************************************
//
...
void DrawPointGoalOptionDescription(int w) { DrawOptionDescription(PointGoalOptionDescriptions, w); }
//****************************************************************************
//
...
void DrawDangerDamageOptionDescription(int w) { DrawOptionDescription(DangerDamageOptionDescriptions, w); }
...
void DrawTimeLimitOptionDescription(int w) { DrawOptionDescription(TimeLimitOptionDescriptions, w); }
...
void DrawColorMenu(void)
{
	...
	DrawColoredMenuBufItem(COLORX - 36, COLORY - 33, W_GetNumForName(playerwadname[locplayerstate->player]), locplayerstate->uniformcolor);
...

{
	...
	do
	{
		...
		case 5:
			BATTLE_Options[gamestate.battlemode].WeaponPersistence = !BATTLE_Options[gamestate.battlemode].WeaponPersistence;
			break;
...
int HandleMultiPageCustomMenu(char** names, int amount, int curpos, char* title, void (*routine)(int w), void (*redrawfunc)(void),
...

{
	...
	level = HandleMultiPageCustomMenu(LevelNames, numlevels, levelcursorpos[whichlevels], "Level Selection", NULL, CP_LevelSelectionRedraw, true);
...
CP_MenuNames SoundSetupMusicNames[] = {"None",	       "Ultrasound",   "Sound Blaster", "Sound Man 16", "Pro Audio Spectrum", "AWE 32", "Soundscape",
				       "Wave Blaster", "General Midi", "Sound Canvas",	"Adlib"};
...
CP_itemtype SoundSetupMusic[]	 = {
	   {CP_CursorLocation, "\0", 'N', (menuptr)SS_SetupMusicCardMenu}, {CP_Active, "\0", 'U', (menuptr)SS_SetupMusicCardMenu},
	   {CP_Active, "\0", 'S', (menuptr)SS_SetupMusicCardMenu},	   {CP_Active, "\0", 'S', (menuptr)SS_SetupMusicCardMenu},
	   {CP_Active, "\0", 'P', (menuptr)SS_SetupMusicCardMenu},	   {CP_Active, "\0", 'A', (menuptr)SS_SetupMusicCardMenu},
	   {CP_Active, "\0", 'S', (menuptr)SS_SetupMusicCardMenu},	   {CP_Active, "\0", 'W', (menuptr)SS_SetupMusicCardMenu},
	   {CP_Active, "\0", 'G', (menuptr)SS_SetupMusicCardMenu},	   {CP_Active, "\0", 'S', (menuptr)SS_SetupMusicCardMenu},
	   {CP_Active, "\0", 'A', (menuptr)SS_SetupMusicCardMenu}};

CP_MenuNames SoundSetupSoundNames[] = {"None",	     "Ultrasound", "Sound Blaster",	  "Sound Man 16",	"Pro Audio Spectrum", "AWE 32",
...
CP_itemtype SoundSetupSound[]	 = {
	   {CP_CursorLocation, "\0", 'N', (menuptr)SS_SetupSoundCardMenu}, {CP_Active, "\0", 'U', (menuptr)SS_SetupSoundCardMenu},
	   {CP_Active, "\0", 'S', (menuptr)SS_SetupSoundCardMenu},	   {CP_Active, "\0", 'S', (menuptr)SS_SetupSoundCardMenu},
	   {CP_Active, "\0", 'P', (menuptr)SS_SetupSoundCardMenu},	   {CP_Active, "\0", 'A', (menuptr)SS_SetupSoundCardMenu},
	   {CP_Active, "\0", 'S', (menuptr)SS_SetupSoundCardMenu},	   {CP_Active, "\0", 'A', (menuptr)SS_SetupSoundCardMenu},
	   {CP_Active, "\0", 'S', (menuptr)SS_SetupSoundCardMenu},	   {CP_Active, "\0", 'T', (menuptr)SS_SetupSoundCardMenu},
	   {CP_Active, "\0", 'P', (menuptr)SS_SetupSoundCardMenu}};

CP_MenuNames SoundSetupMidiPortNames[] = {"220", "230", "240", "250", "300", "320", "330", "332", "334", "336", "340", "360"};

CP_iteminfo SoundSetupMidiPortItems = {108, MENU_Y + 10, 12, STARTITEM, 16, SoundSetupMidiPortNames, mn_smallfont};
CP_itemtype SoundSetupMidiPort[]    = {{CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
				       {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_CursorLocation, "\0", 'a', NULL},
				       {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
				       {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}};

CP_MenuNames SoundSetupVoiceNames[] = {"1 voice", "2 voices", "3 voices", "4 voices", "5 voices", "6 voices", "7 voices", "8 voices"};

CP_iteminfo SoundSetupVoiceItems = {MENU_X + 36, 24, 8, STARTITEM, 32, SoundSetupVoiceNames, mn_largefont};
CP_itemtype SoundSetupVoice[]	 = {{CP_CursorLocation, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
				    {CP_Active, "\0", 'a', NULL},	  {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
...
CP_itemtype PortMenu[] = {{CP_CursorLocation, "\0", '2', NULL}, {CP_Active, "\0", '2', NULL}, {CP_Active, "\0", '2', NULL},
			  {CP_Active, "\0", '2', NULL},		{CP_Active, "\0", '2', NULL}, {CP_Active, "\0", '2', NULL},
			  {CP_Active, "\0", '2', NULL}};
...
CP_itemtype _8BitDMAMenu[] = {{CP_CursorLocation, "\0", '0', NULL}, {CP_Active, "\0", '1', NULL}, {CP_Active, "\0", '3', NULL}};
...
CP_itemtype _16BitDMAMenu[] = {{CP_CursorLocation, "\0", '5', NULL}, {CP_Active, "\0", '6', NULL}, {CP_Active, "\0", '7', NULL}};
...
CP_itemtype IrqMenu[] = {{CP_CursorLocation, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
			 {CP_Active, "\0", 'a', NULL},	       {CP_Active, "\0", 'a', NULL}, {CP_Active, "\0", 'a', NULL},
			 {CP_Active, "\0", 'a', NULL},	       {CP_Active, "\0", 'a', NULL}};
...

{
	int status;
	int select;
	if (((musicnums[handlewhich] == SoundBlaster) || (musicnums[handlewhich] == WaveBlaster) || (musicnums[handlewhich] == Awe32)) &&
	...
	if ((musicnums[MusicMode] == GenMidi) || (musicnums[MusicMode] == SoundCanvas) || (musicnums[MusicMode] == WaveBlaster) ||
