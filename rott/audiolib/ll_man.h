...
#define LL_AddToHead(type, listhead, node)                                                                                                           \
	LL_AddNode((char*)(node), (char**)&((listhead)->start), (char**)&((listhead)->end), (int)&((type*)0)->next, (int)&((type*)0)->prev)

#define LL_AddToTail(type, listhead, node)                                                                                                           \
	LL_AddNode((char*)(node), (char**)&((listhead)->end), (char**)&((listhead)->start), (int)&((type*)0)->prev, (int)&((type*)0)->next)

#define LL_Remove(type, listhead, node)                                                                                                              \
	LL_RemoveNode((char*)(node), (char**)&((listhead)->start), (char**)&((listhead)->end), (int)&((type*)0)->next, (int)&((type*)0)->prev)
