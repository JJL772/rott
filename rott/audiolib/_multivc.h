...
typedef struct VoiceNode
{
	...
	void (*mix)(unsigned long position, unsigned long rate, const char* start, unsigned long length);
...
#ifdef PLAT_DOS
#pragma aux ClearBuffer_DW = "cld", "push   es", "push   ds", "pop    es", "rep    stosd", "pop    es", parm[edi][eax][ecx] modify exact[ecx edi];
#endif
