...
static void* D32DosMemAlloc(unsigned long size)
...
void rmcallback(unsigned short _far* stkp)
...
static void _interrupt _cdecl callback_x(
	...
	int rgs, int rfs, int res, int rds, int rdi, int rsi, int rbp, int rsp, int rbx, int rdx, int rcx, int rax)
